...
add wave -noupdate -radix binary /tb_top/send_byte_expected_Dplus_3/data_byte
...
add wave -noupdate /tb_top/DUT/TXDBUFF/buffer_occupancy
add wave -noupdate /tb_top/DUT/TXDBUFF/buffer_occupancy1
add wave -noupdate /tb_top/DUT/TXDBUFF/clear
add wave -noupdate /tb_top/DUT/TXDBUFF/clk
add wave -noupdate /tb_top/DUT/TXDBUFF/data_in
add wave -noupdate /tb_top/DUT/TXDBUFF/data_out
add wave -noupdate /tb_top/DUT/TXDBUFF/empty
add wave -noupdate /tb_top/DUT/TXDBUFF/full
add wave -noupdate /tb_top/DUT/TXDBUFF/get_tx_packet_data
add wave -noupdate /tb_top/DUT/TXDBUFF/hsize
add wave -noupdate /tb_top/DUT/TXDBUFF/mem
add wave -noupdate /tb_top/DUT/TXDBUFF/n_rst
add wave -noupdate /tb_top/DUT/TXDBUFF/next_buffer_occupancy
add wave -noupdate /tb_top/DUT/TXDBUFF/next_read_ptr
add wave -noupdate /tb_top/DUT/TXDBUFF/next_tx_packet_data
add wave -noupdate /tb_top/DUT/TXDBUFF/next_write_ptr1
add wave -noupdate /tb_top/DUT/TXDBUFF/read_ptr
add wave -noupdate /tb_top/DUT/TXDBUFF/shift_reg
add wave -noupdate /tb_top/DUT/TXDBUFF/store_tx_data
add wave -noupdate /tb_top/DUT/TXDBUFF/tx_data
add wave -noupdate /tb_top/DUT/TXDBUFF/tx_packet_data
add wave -noupdate /tb_top/DUT/TXDBUFF/write_addr
add wave -noupdate /tb_top/DUT/TXDBUFF/write_ptr1
...
add wave -noupdate -radix binary /tb_top/DUT/TX/SHIFT_REG/tx_packet_data
add wave -noupdate /tb_top/DUT/TX/SHIFT_REG/counter
add wave -noupdate -radix binary /tb_top/DUT/TX/SHIFT_REG/tx_packet_out
add wave -noupdate /tb_top/DUT/TX/SHIFT_REG/tx_packet_out_held
add wave -noupdate -divider -height 25 RX
add wave -noupdate /tb_top/DUT/RX/dp_i
add wave -noupdate /tb_top/DUT/RX/dm_i
add wave -noupdate /tb_top/DUT/RX/buffer_occupancy
...
add wave -noupdate /tb_top/DUT/RXDBUFF/data_out
add wave -noupdate /tb_top/DUT/RXDBUFF/next_buffer_occupancy_rx
add wave -noupdate /tb_top/tb_expected_dminus_o
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {24935 ps} 0}
...
update
WaveRestoreZoom {0 ps} {224988 ps}
