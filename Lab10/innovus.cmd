...
#  Created on Thu Mar 28 12:17:09 2024                
#                                                     
#######################################################
...
set fpIsMaxIoHeight 0If you log on to support.cadence.com, you'll see an icon for Product Manuals. Click that, then you'll see Innovus in the list under Digital IC Design.
...
fit
selectMarker 330.1500 298.8000 1169.8500 1123.2000 -1 3 7
setLayerPreference violation -isVisible 1
uiKit::addWidget vb -type main
violationBrowser -all -no_display_false
zoomBox -89.7 -121.05 1589.7 1543.05
zoomBox -89.7 -121.05 1589.7 1543.05
fit
fit
fit
...
verifyConnectivity -type all -error 1000 -warning 50
verifyConnectivity -type all -error 1000 -warning 50
gui_select -rect {602.910 406.923 998.091 -125.781}
gui_select -rect {1758.419 282.046 2125.147 -113.135}
gui_select -rect {941.185 -130.523 1156.164 -331.275}
uiSetTool select
verifyConnectivity -type all -error 1000 -warning 50
verifyConnectivity -type all -error 1000 -warning 50
verifyConnectivity -type all -error 1000 -warning 50
